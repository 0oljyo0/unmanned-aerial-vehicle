...
#define NRF_CSN_HIGH()      GPIO_SetBits(GPIOB, GPIO_Pin_8)
#define NRF_CSN_LOW()      GPIO_ResetBits(GPIOB, GPIO_Pin_8)		 //csn置低
#define NRF_CE_HIGH()	   GPIO_SetBits(GPIOB,GPIO_Pin_9)
#define NRF_CE_LOW()	   GPIO_ResetBits(GPIOB,GPIO_Pin_9)			  //CE置低
#define NRF_Read_IRQ()		GPIO_ReadInputDataBit ( GPIOA, GPIO_Pin_1) //中断引脚
...
u8 NRF_Check(void); 
void huoqu_yaokongqizhi(int16_t *youmen,int16_t *qianhou,int16_t *zuoyou,int16_t *xuanzhuan) ;
