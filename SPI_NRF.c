...
void huoqu_yaokongqizhi(int16_t *youmen,int16_t *qianhou,int16_t *zuoyou,int16_t *xuanzhuan) //获取遥控器控制数据 且归一化到+50角度 —— -50角度
{
	*youmen=(rxbuf[6]*100+rxbuf[7])/5-150;
	*qianhou=-(rxbuf[2]*100+rxbuf[3]-2016);
	*zuoyou=rxbuf[0]*100+rxbuf[1]-2039;
	*xuanzhuan=(rxbuf[4]*100+rxbuf[5]-1993)*20;
